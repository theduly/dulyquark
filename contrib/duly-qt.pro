...
RESOURCES += src/qt/duly.qrc src/qt/duly_locale.qrc

TRANSLATIONS += src/qt/locale/duly_bg.ts \
                src/qt/locale/duly_de.ts \
                src/qt/locale/duly_en.ts \
                src/qt/locale/duly_es.ts \
                src/qt/locale/duly_fi.ts \
                src/qt/locale/duly_fr.ts \
                src/qt/locale/duly_it.ts \
                src/qt/locale/duly_ja.ts \
                src/qt/locale/duly_pl.ts \
                src/qt/locale/duly_pt.ts \
                src/qt/locale/duly_ru.ts \
                src/qt/locale/duly_sk.ts \
                src/qt/locale/duly_sv.ts \
                src/qt/locale/duly_vi.ts \
                src/qt/locale/duly_zh_CN.ts \
                src/qt/locale/duly_zh_TW.ts
