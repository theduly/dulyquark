...
This mechanism has been integrated into Bitcore-Node-DULY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DULY-Project/insight-api-duly#web-socket-api](https://github.com/DULY-Project/insight-api-duly#web-socket-api) 
* API: [https://github.com/DULY-Project/insight-api-duly#swifttx-transactions](https://github.com/DULY-Project/insight-api-duly#swifttx-transactions) 
...
By default, the DULY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DULY Core daemon:
