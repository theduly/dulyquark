...
In order to support loading of multiple wallets in duly-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is duly.cpp.
...
Changes to duly.cpp
----------------------
duly.cpp is the entry point into duly-qt, and as such, will require some minor modifications to provide hooks for
