Contributing to DULY Core
============================

The DULY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DULY Core project, and is not to be
confused with overall DULY Network Protocol consensus changes.

Whether a pull request is merged into DULY Core rests with the project merge
...
Patches that change DULY consensus rules are considerably more involved than
...
Where a patch set proposes to change the DULY consensus, it must have been
...
The project leader is the release manager for each DULY Core release.
