...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Duly features */
        {"duly", "masternode", &masternode, true, true, false},
        {"duly", "masternodelist", &masternodelist, true, true, false},
        {"duly", "mnbudget", &mnbudget, true, true, false},
        {"duly", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"duly", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"duly", "mnsync", &mnsync, true, true, false},
        {"duly", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"duly", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dulyd, or the -server option to duly-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> duly-cli " + methodname + " " + args + "\n";
}
