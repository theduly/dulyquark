                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DULY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DULY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and duly: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DULY Core"), this);
    aboutAction->setStatusTip(tr("Show information about DULY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DULY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DULY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DULY addresses"));
    ...
    openAction->setStatusTip(tr("Open a DULY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DULY Core help message to get a list with possible DULY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DULY Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("DULY Core"); // default title
